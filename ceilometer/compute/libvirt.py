...
def make_vnic_counter(instance, name, type, volume, vnic_data):
    resource_metadata = {
                         ...
                         'address': vnic_data['mac'],
                         'alias': vnic_data['alias'],
                         'bridge': vnic_data['bridge'],
                         'ip': vnic_data['ip'],
                         'projmask': vnic_data['projmask'],
                         'projnet': vnic_data['projnet'],
                         'dhcp_server': vnic_data['dhcp_server']
                        }
    return counter.Counter(
        source='?',
        name=name,
